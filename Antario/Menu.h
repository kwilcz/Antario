...
struct MenuStyle
{
    ...
    Color colCheckbox1    = { 215, 0, 115, 255 };    /*- Color of the first gradient color of the checkbox   -*/
    Color colCheckbox2    = { 200, 0, 100, 255 };    /*- Color of the second gradient color of the checkbox  -*/
